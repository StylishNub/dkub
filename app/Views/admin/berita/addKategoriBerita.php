...
<div class="max-w-2xl mx-auto mt-12 px-6 py-8 bg-white dark:bg-gray-900 shadow-md rounded-xl">
    ...
    <!-- Judul -->
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">🗂️ Tambah Kategori Berita</h1>
    ...
    <!-- Form -->
    <form action="/tambah_kategori_berita/save_kategori_berita" method="post" class="space-y-6">
        <!-- Nama Kategori -->
        <div>
        ...
        <!-- Deskripsi Kategori -->
        <div>
            <label for="deskripsi" class="block mb-2 text-sm font-medium text-gray-700 dark:text-white">Deskripsi Kategori</label>
