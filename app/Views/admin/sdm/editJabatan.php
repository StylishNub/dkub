...
<div class="max-w-3xl mx-auto mt-12 px-6 py-8 bg-white dark:bg-gray-900 shadow-md rounded-xl">
    ...
    <!-- Judul -->
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Edit Jabatan</h1>
    ...
    <!-- Form -->
    <form action="/edit_jabatan/save_editJabatan" method="post" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" name="nama_jabatan" id="nama_jabatan" value="<?= esc($jabatan['nama_jabatan']) ?>" required
        ...
        <div>
            ...
            <textarea name="tupoksi_jabatan" id="tupoksi_jabatan" rows="5" required
                      class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"><?= esc($jabatan['tupoksi_jabatan']) ?></textarea>
        </div>
