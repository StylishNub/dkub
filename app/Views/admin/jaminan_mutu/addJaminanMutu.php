...
<div class="max-w-3xl mx-auto mt-12 px-6 py-8 bg-white dark:bg-gray-900 shadow-md rounded-xl">
    ...
    <!-- Judul -->
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Tambah Indikator Jaminan Mutu</h1>
    ...
    <!-- Form -->
    <form action="/tambah_jaminan_mutu/save_jaminan_mutu" method="post" enctype="multipart/form-data" class="space-y-6">
        <!-- Indikator -->
        <div>
